...
constexpr ::std::int64_t timestamp = 1661232206;
namespace netvars {
...
constexpr ::std::ptrdiff_t dwForceAttack = 0x320CE2C;
constexpr ::std::ptrdiff_t dwForceAttack2 = 0x320CE38;
constexpr ::std::ptrdiff_t dwForceBackward = 0x320CDD8;
constexpr ::std::ptrdiff_t dwForceForward = 0x320CE5C;
constexpr ::std::ptrdiff_t dwForceJump = 0x52868EC;
constexpr ::std::ptrdiff_t dwForceLeft = 0x320CDE4;
constexpr ::std::ptrdiff_t dwForceRight = 0x320CDF0;
constexpr ::std::ptrdiff_t dwGameDir = 0x62B900;
constexpr ::std::ptrdiff_t dwGameRulesProxy = 0x52FA11C;
constexpr ::std::ptrdiff_t dwGetAllClasses = 0xDEACAC;
constexpr ::std::ptrdiff_t dwGlobalVars = 0x58CCE0;
constexpr ::std::ptrdiff_t dwGlowObjectManager = 0x53255D8;
constexpr ::std::ptrdiff_t dwInput = 0x522DEE0;
constexpr ::std::ptrdiff_t dwInterfaceLinkList = 0x970284;
constexpr ::std::ptrdiff_t dwLocalPlayer = 0xDC04CC;
constexpr ::std::ptrdiff_t dwMouseEnable = 0xDC61D8;
constexpr ::std::ptrdiff_t dwMouseEnablePtr = 0xDC61A8;
constexpr ::std::ptrdiff_t dwPlayerResource = 0x320B170;
constexpr ::std::ptrdiff_t dwRadarBase = 0x5211684;
constexpr ::std::ptrdiff_t dwSensitivity = 0xDC6074;
constexpr ::std::ptrdiff_t dwSensitivityPtr = 0xDC6048;
constexpr ::std::ptrdiff_t dwSetClanTag = 0x8A410;
constexpr ::std::ptrdiff_t dwViewMatrix = 0x4DCE224;
constexpr ::std::ptrdiff_t dwWeaponTable = 0x522E9A4;
constexpr ::std::ptrdiff_t dwWeaponTableIndex = 0x326C;
constexpr ::std::ptrdiff_t dwYawPtr = 0xDC5E38;
constexpr ::std::ptrdiff_t dwZoomSensitivityRatioPtr = 0xDCC620;
constexpr ::std::ptrdiff_t dwbSendPackets = 0xD8542;
constexpr ::std::ptrdiff_t dwppDirect3DDevice9 = 0xA6050;
constexpr ::std::ptrdiff_t find_hud_element = 0x5A615C30;
...
constexpr ::std::ptrdiff_t m_pitchClassPtr = 0x5211920;
constexpr ::std::ptrdiff_t m_yawClassPtr = 0xDC5E38;
