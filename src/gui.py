...
def init_gui() -> None:
    ...
    while dpg.is_dearpygui_running():
        ...
        settings_list: tuple = ("enemy_glow_enabled", "glow_colour_enemy", "team_glow_enabled", "glow_colour_team",
                                "radar_enabled", "trigger_enabled", "trigger_delay", "trigger_key", "bhop_enabled",
                                "bhop_delay", "skin_changer_enabled")

        settings_list = map(dpg.get_value, settings_list)
        settings.update_vars(tuple(settings_list))
